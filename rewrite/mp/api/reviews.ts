...
export const submitReview = (orderId: string, lineId: string, rating: number, text: string, tags: string[], anon: boolean): Promise<ApiResult> =>
  callApp('submitReview', { orderId, lineId, rating, text, tags, anon })
