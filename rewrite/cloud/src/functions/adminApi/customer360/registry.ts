...
import { checkpointsProvider } from './providers/checkpoints'
...
// 顺序由各 provider.order 字段定（profile 5 / orders 10 / activation 20 / learning 30 / checkpoints 40）·此处排列不决定最终序。
const PROVIDERS: CustomerPanelProvider[] = [profileProvider, ordersProvider, activationProvider, learningProvider, checkpointsProvider]
