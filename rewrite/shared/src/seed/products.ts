...
export const SEED_PRODUCTS: SeedProduct[] = [
  { id: 'prod-1', name: '小棉鸭礼盒', tag: '送礼首选', price: 198, was: 258, featured: true, sort: 0, courseId: 'course-duck' },
  ...
  { id: 'prod-4', name: '小棉鸭 · 单只', tag: '单只装', price: 98, was: 138, featured: false, sort: 3, courseId: 'course-duck' },
