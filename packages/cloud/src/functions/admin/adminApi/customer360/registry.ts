...
// 顺序由各 provider.order 字段定（profile 5 概览在前 / orders 10 / activation 20）·此处排列不决定最终序。
const PROVIDERS: CustomerPanelProvider[] = [profileProvider, ordersProvider, activationProvider]
