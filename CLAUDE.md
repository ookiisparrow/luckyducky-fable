...
## 📁 docs/ 文档地图
- `设计规格-课程电商系统.md` — 微信云开发全栈目标系统的设计(数据模型/核心机制/分阶段 P0–P5)。
- `代码标准.md` — 审核 + 自查的尺子(21 维 + P0–P3 + uni-app 专项 + red flags)。
- `审核报告-v0.1.md` — 按代码标准的全量审核(无 P0/P1)。
- `技术债与重构.md` — 审核 backlog(标真 bug / 重构、是否结合云开发)。
- `调试日志.md` — bug 账本(现象/根因/同类隐患/结构性/状态)。
- `Git协作约定.md` — 分支/版本/推送约定(GitHub 为中心、本地单一最新、tag 做版本)。
- `工作日志.md` — 按日期的工作记录/进展(最新在上)。
