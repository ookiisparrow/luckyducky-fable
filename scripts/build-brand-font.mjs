 ...
 * 只取 Medium(500)/Bold(700) 两个 `--font-display` 实际用到的字重，出 woff2（M+B 合计 ~1.5MB）。
 ...
 *
 * 字符集变了（文案出现 GB2312 一级外的字）或要加字重时，改本脚本重跑、提交新 woff2、重新部署到托管。
 */
...
const WEIGHTS = [
  { src: 'WenYuanRoundedSC-Medium.otf', out: 'wenyuan-rounded-medium.woff2', weight: 500 },
  { src: 'WenYuanRoundedSC-Bold.otf', out: 'wenyuan-rounded-bold.woff2', weight: 700 },
]
